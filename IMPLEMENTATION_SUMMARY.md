...
```html
<div class="card-primary">...</div>     <!-- Red accent -->
<div class="card-secondary">...</div>   <!-- Indigo accent (NEW!) -->
<div class="card-accent">...</div>      <!-- Emerald accent -->
<div class="card-success">...</div>     <!-- Teal accent -->
<div class="card-warning">...</div>     <!-- Amber accent -->
<div class="card-error">...</div>       <!-- Rose accent -->
```
