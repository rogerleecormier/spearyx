...
export default function Header() {
  ...
  const isOnTools = location.pathname.startsWith("/");
  const isOnJobs = false;
  ...
  return (
    <SharedHeader logo={logo} label="Tools">
      {/* Tools Dropdown */}
      ...
      {isDev && (
        <DropdownMenu modal={false}>
          ...
          <DropdownMenuContent align="end" className="w-48">
            ...
            <DropdownMenuItem asChild>
              <a href="https://spearyx.com/typography" className="flex items-center">
                <Layers size={16} className="mr-2 text-primary-500" />
