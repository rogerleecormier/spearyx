...
// Initial list of potential companies to discover (200+ companies)
...
async function seedPotentialCompanies() {
  console.log('🌱 Seeding potential companies...');
...
seedPotentialCompanies().catch(error => {
