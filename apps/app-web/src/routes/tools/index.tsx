...
import { Hero, Body, Overline, Headline } from "@spearyx/ui-kit";

export const Route = createFileRoute("/tools/")({ component: App });
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="py-24 px-4 bg-slate-50 border-b border-slate-200">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <Headline className="text-slate-950 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div className="bg-white border border-slate-200 rounded-xl p-8 hover:shadow-lg transition-all duration-300">
              <div className="text-4xl mb-4">⚡</div>
              <Headline as="h3" className="text-slate-950 mb-3 text-lg">
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <Overline className="text-primary-600 mb-4">AI-Powered Tools</Overline>
            <Headline className="text-slate-950 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {tools.map((tool, index) => (
              <a
                key={index}
                href={tool.link}
                className="bg-white border border-slate-200 rounded-xl p-6 hover:border-primary-300 hover:shadow-md transition-all duration-300 group block"
              >
                <div className="text-4xl mb-3">{tool.icon}</div>
                <Headline
                  as="h3"
                  className="text-slate-950 mb-2 text-base group-hover:text-primary-600 transition-colors"
                >
                  {tool.title}
                </Headline>
                <Body size="sm" className="text-slate-600">
