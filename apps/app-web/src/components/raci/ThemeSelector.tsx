    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="relative">
        <button
          ...
          className="w-full px-3 py-2 border border-slate-300 rounded-md bg-white text-left hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors"
            ...
            {themeList.map((t) => (
              <button
                ...
                className={`w-full px-3 py-2 text-left hover:bg-slate-100 transition-colors first:rounded-t-md last:rounded-b-md ${
                  t.id === theme
                    ? "bg-indigo-50 border-l-2 border-l-indigo-500 pl-2"
                    : ""
                }`}
                role="option"
