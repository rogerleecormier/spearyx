      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-start justify-between">
            <div>
              <Overline className="text-primary-600 mb-2">Project Tools</Overline>
              <Hero className="text-slate-950 mb-2">RACI Matrix Generator</Hero>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-3 space-y-6 order-2 lg:order-2">
            ...
            <div className="space-y-3">
              ...
              <Card className="border-accent-200 bg-gradient-to-br from-accent-50 to-white shadow-sm hover:shadow-md transition-shadow">
                <CardHeader className="pb-4 border-b border-accent-200">
                  <div className="flex items-center gap-2">
                    <span className="text-lg">⬇️</span>
                    <div>
                      <Label className="text-accent-700 font-semibold text-sm block">
                        Export & Download
                      </Label>
            ...
            {/* Danger Zone */}
            <Card className="border-error-200 bg-error-50 shadow-sm">
              <CardHeader>
                <CardTitle className="text-xs text-error-600">
                  Danger Zone
                </CardTitle>
              </CardHeader>
              <CardContent>
