import { ExternalLink, Calendar, DollarSign, Building2, Eye } from 'lucide-react'
...
function getTruncatedDescription(html: string | null, maxLength: number = 200): string {
  if (!html) return ''
    ...
    <>
      <div className="job-card">
        <div className="job-card-header">
          ...
          <span className="category-badge-small">{job.category.name}</span>
