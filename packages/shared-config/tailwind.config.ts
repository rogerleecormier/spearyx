 ...
 * Single source of truth for all color palettes, typography, and design tokens
 * Used by: @spearyx/app-web, @spearyx/corporate, @spearyx/jobs
 */
  ...
  theme: {
    colors: {
      ...
      primary: {
        ...
        "600": "#dc2626", // Use for main text/actions
        "700": "#b91c1c",
        "800": "#991b1b",
        "900": "#7f1d1d",
        "950": "#450a0a",
      ...
      // Error/Destructive - Rose (Destructive actions)
      error: {
        "50": "#fff5f7",
        "100": "#ffe4e9",
        "200": "#ffd4db",
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "secondary-glow": "0 0 20px rgb(99 102 241 / 0.3)",
    ...
    function ({ addUtilities }: { addUtilities: (utilities: any) => void }) {
      const newUtilities = {
        ...
        ".btn-secondary": {
          ...
          "&:focus": {
            outline: "none",
            boxShadow: "0 0 0 3px rgb(99 102 241 / 0.3)",
          },
        },
        ".btn-accent": {
          borderRadius: "0.5rem",
        ...
        ".badge-error": {
          "@apply badge-modern": {},
          border: "1px solid rgb(255 107 133 / 0.2)",
          background: "rgb(255 107 133 / 0.1)",
          color: "#ff6b85",
        },
        ".badge-neutral": {
          "@apply badge-modern": {},
        ...
        ".text-primary-light": { color: "rgb(239 68 68 / 0.7)" },
        ".text-primary-muted": { color: "rgb(239 68 68 / 0.5)" },

        // Secondary text colors
        ".text-secondary": { color: "#6366f1" },
        ".text-secondary-light": { color: "rgb(99 102 241 / 0.7)" },
        ".text-secondary-muted": { color: "rgb(99 102 241 / 0.5)" },

        // Accent text colors
        ".text-accent": { color: "#22c55e" },
        ".text-accent-light": { color: "rgb(34 197 94 / 0.7)" },
        ".text-accent-muted": { color: "rgb(34 197 94 / 0.5)" },

        // Semantic text colors
        ".text-success": { color: "#14b8a6" },
        ".text-success-light": { color: "rgb(20 184 166 / 0.7)" },
        ".text-warning": { color: "#f59e0b" },
        ".text-warning-light": { color: "rgb(245 158 11 / 0.7)" },
        ".text-error": { color: "#ff6b85" },
        ".text-error-light": { color: "rgb(255 107 133 / 0.7)" },
        ".text-info": { color: "#3b82f6" },
        ".text-info-light": { color: "rgb(59 130 246 / 0.7)" },

        // Neutral text colors
        ".text-neutral-dark": { color: "rgb(17 24 39)" },
        ".text-neutral": { color: "rgb(107 114 128)" },
        ".text-neutral-light": { color: "rgb(156 163 175)" },
        ".text-neutral-lighter": { color: "rgb(209 213 219)" },
      };
